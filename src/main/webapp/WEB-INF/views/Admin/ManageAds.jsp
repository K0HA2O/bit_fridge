...
<body class="p-4">
	...
	<div class="recipe-header m-2 p-5">
		<div>
			<span class="recipe-title">광고 관리</span> <span class="fresh-date">
		...
		<div class="container text-center mt-4">
			...
			<table class="table table-hover">
				...
				<c:forEach var="ad" items="${ads}">
					<tr>
						<td><img src="${ad.imageUrl}" alt="광고 이미지" width="400"></td>
						<td><a href="${ad.linkUrl}" target="_blank">${ad.linkUrl}</a></td>
						<td>${ad.isActive ? '활성화' : '비활성화' }</td>
						<td class="actions"><a href="deleteAd?id=${ad.id }"
							onclick="return confirm('삭제하시겠습니까?');" class="delete-btn">삭제</a></td>
					</tr>
				</c:forEach>
			</table>

			<a href="addAd" class="recipe-button">광고 추가</a>
