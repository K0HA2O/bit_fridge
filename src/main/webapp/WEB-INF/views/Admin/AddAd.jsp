...
<body class="p-4">
	...
	<div class="recipe-header m-2 p-5">
		<div>
			<span class="recipe-title">광고 추가</span>
	...
	<main>
		<div class="container text-center mt-4">
			...
			<form action="./addAdProcess" method="post"
				enctype="multipart/form-data">
				<table class="table table-borderless">
					<tr>
						<th class="text-start p-2">광고 링크</th>
						<td><input type="text" name="linkUrl" size="50"
							class="form-control" required></td>
					</tr>

					<tr>
						<th class="text-start p-2">이미지</th>
						<td><input type="file" name="imagePath" accept="image/png" class="form-control"
							required></td>
					</tr>
					
					<tr>
						<th class="text-start p-2">활성화 여부</th>
					...
					<tr>
						<td colspan="2" style="text-align: center;">
							<button type="submit" class="recipe-button">추가</button>
						</td>
					</tr>
				</table>
			</form>
