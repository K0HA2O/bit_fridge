...
<body class="p-4">
	...
	<div class="recipe-header m-2 p-5">
		<div>
			<span class="recipe-title">게시글 수정</span> <span class="fresh-date">
				...
				<table class="table table-borderless">
					<tr>
						...
						<td><input class="form-control" type="text" name="title"
							value="${post.title}" size="50" required placeholder="제목을 입력하세요"></td>
					</tr>
					<tr>
						<th class="text-start p-2">내용</th>
						<td><textarea class="form-control" name="content" rows="10"
								cols="50" required placeholder="내용을 입력하세요">${post.content}</textarea></td>
					</tr>
					<!-- 기존 이미지를 표시 -->
					<c:if test="${not empty post.imagePath}">
						<tr>
							<th class="text-start p-2">기존 이미지</th>
							<td><img src="${post.imagePath}" alt="이미지" width="200"></td>
						</tr>
					</c:if>
					<tr>
						<th class="text-start p-2">이미지 경로</th>
						<td><input class="form-control" type="file" name="imagePath"
							accept="imagePath/*"></td>
					</tr>
				</table>

				<a href="list" class="btn btn-outline-secondary">목록보기</a>
