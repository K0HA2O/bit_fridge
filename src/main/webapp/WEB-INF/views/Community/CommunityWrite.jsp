...
<body class="p-4">
	...
	<div class="recipe-header m-2 p-5">
		<div>
			<span class="recipe-title">게시글 작성</span> <span class="fresh-date">
            ...
            <form action="write" method="post" enctype="multipart/form-data">
                <table class="table table-borderless">
                    <tr>
                        ...
                        <td><input type="text" name="title" size="50" class="form-control" required></td>
                    </tr>
                    <tr>
                        <th class="text-start p-2">내용</th>
                        <td><textarea name="content" rows="10" cols="50" class="form-control" required></textarea></td>
                    </tr>
                    <tr>
                        <th class="text-start p-2">이미지</th>
                        <td><input type="file" name="imagePath" class="form-control" accept="image/png"></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <button type="submit" class="recipe-button">작성</button>
                            <a href="list" class="list-btn">목록보기</a>
                        </td>
                    </tr>
                </table>
            </form>
